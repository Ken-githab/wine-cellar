            ...
            <div className="flex items-center gap-2">
              ...
              {!drinkCompleted && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-[#634B99] text-white text-sm font-semibold transition hover:bg-[#1E0F38] active:scale-95 shadow-[0_2px_8px_rgba(99,75,153,0.3)]">
